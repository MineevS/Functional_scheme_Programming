...
QExprWidget::QExprWidget(QWidget *parent)
  : QWidget(parent){
  m_expression_alignment.setFlag(Qt::AlignCenter);
  m_alignment.setFlag(Qt::AlignCenter);
}
void QExprWidget::setVisibleAxisX(bool value){
...
void QExprWidget::setVisibleAxisY(bool value){
...
void QExprWidget::setExpression(ExpressionPtr expression){
...
void QExprWidget::setExpressionAlignment(Qt::Alignment alignment){
...
void QExprWidget::setAlignment(Qt::Alignment alignment){
...
void QExprWidget::paintEvent(QPaintEvent* event){
...
void QExprWidget::paintExpression(){
  if (m_expression) {
    int x = 0;
