/*!
 ...
 @copyright FreeSoft.
 @brief     Содержит реализация неграфического компонента QTelnet.
...
{
    // connect( this, SIGNAL(error(QAbstractSocket::SocketError)), this, SLOT(socketError(QAbstractSocket::SocketError)) );//01.06.24;
